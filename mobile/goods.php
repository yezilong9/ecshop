...
//{
    ...
    else
    {
        ...
        */
        ...
        //dump(get_goods_gallery($goods_id));
...
{
	if($_REQUEST['state'] == 'buy') $smarty->assign('state','1');
	$goods_name = $goods['goods_style_name'];
	if(strlen($goods['goods_style_name']) > 15)
	{
		$goods_name = mb_substr($goods['goods_style_name'],0,15,'utf-8').'...';
	}
	$smarty->assign('goods_name',$goods_name);
	$smarty->display('goods_attr.dwt');exit;
}
