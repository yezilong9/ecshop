...
/* 仿真 Adodb 函数 */
    ...
    */
    ...
    public function begin($mode = NULL)
    {
        ...
        $this->link_id or $this->connect();

        if ($mode AND ! mysql_query("SET TRANSACTION ISOLATION LEVEL $mode", $this->link_id))
        {
            $this->ErrorMsg(':error：'.mysql_error($this->link_id));
            return false;
            
        }

        return (bool) mysql_query('START TRANSACTION', $this->link_id);
    }
    ...
    */
    ...
    public function commit()
    {
        ...
        return (bool) mysql_query('COMMIT', $this->link_id);
    }
    ...
    */
    ...
    public function rollback()
    {
        ...
        return (bool) mysql_query('ROLLBACK', $this->link_id);
    }
