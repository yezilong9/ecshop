...
// 批量上传商品的字段
$_LANG['export_'] = 'Export to  data format';
$_LANG['']['goods_name'] = '商品名称';
$_LANG['']['goods_sn'] = '商品货号';
$_LANG['']['brand_name'] = '商品品牌';   // 需要转换成brand_id
$_LANG['']['market_price'] = '市场售价';
$_LANG['']['shop_price'] = '本店售价';
$_LANG['']['integral'] = '积分购买额度';
$_LANG['']['original_img'] = '商品原始图';
$_LANG['']['goods_img'] = '商品图片';
$_LANG['']['goods_thumb'] = '商品缩略图';
$_LANG['']['keywords'] = '商品关键词';
$_LANG['']['goods_brief'] = '简单描述';
$_LANG['']['goods_desc'] = '详细描述';
$_LANG['']['goods_weight'] = '商品重量（kg）';
$_LANG['']['goods_number'] = '库存数量';
$_LANG['']['warn_number'] = '库存警告数量';
$_LANG['']['is_best'] = '是否精品';
$_LANG['']['is_new'] = '是否新品';
$_LANG['']['is_hot'] = '是否热销';
$_LANG['']['is_on_sale'] = '是否上架';
$_LANG['']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['']['is_real'] = '是否实体商品';
