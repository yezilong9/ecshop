...
$_LANG['unrecognize_version'] ='Can\'t identify the  version of the backup sql.';
...
$_LANG['version_error'] =' current version the %s and the backup data version the %s is different, the backup restore failure.';
