...
$_LANG['filecheck_tips_step1'] = ' check documents for the official release of the documents as the basis for cross-checking, click the button below to start checking。';
