...
$_LANG['dir_notes'] ='Please notice root directory path of the old shop, please use opposite path of the admin directory.<Br/>For example:The old shop directory is shop in root directory, but the  put in root directory, that path is../shop.';
