...
Usage:
     ...
     3:If you do not need any user\'s system integration, please select  installed plug-ins, you can uninstall all of
...
$_LANG['ucenter_notice_key'] = 'Communication key for UCenter and  information between the transmission of encrypted, can contain any letters and numbers, please UCenter with identical settings  communication key to ensure that the two systems, normal communication can';
...
$_LANG['uc_notice_ip'] = 'Some effort to connect the process of problem, please fill out the server IP address, if you have UC and  mounted on the same server, we recommend that you try to fill in 127.0.0.1';
