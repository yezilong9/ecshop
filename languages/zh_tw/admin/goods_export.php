...
// 批量上傳商品的字段
$_LANG['export_'] = '導出到數據格式';
$_LANG['']['goods_name'] = '商品名稱';
$_LANG['']['goods_sn'] = '商品貨號';
$_LANG['']['brand_name'] = '商品品牌';   // 需要轉換成brand_id
$_LANG['']['market_price'] = '市場售價';
$_LANG['']['shop_price'] = '本店售價';
$_LANG['']['integral'] = '積分購買額度';
$_LANG['']['original_img'] = '商品原始圖';
$_LANG['']['goods_img'] = '商品圖片';
$_LANG['']['goods_thumb'] = '商品縮略圖';
$_LANG['']['keywords'] = '商品關鍵詞';
$_LANG['']['goods_brief'] = '簡單描述';
$_LANG['']['goods_desc'] = '詳細描述';
$_LANG['']['goods_weight'] = '商品重量（kg）';
$_LANG['']['goods_number'] = '庫存數量';
$_LANG['']['warn_number'] = '庫存警告數量';
$_LANG['']['is_best'] = '是否精品';
$_LANG['']['is_new'] = '是否新品';
$_LANG['']['is_hot'] = '是否熱銷';
$_LANG['']['is_on_sale'] = '是否上架';
$_LANG['']['is_alone_sale'] = '能否作為普通商品銷售';
$_LANG['']['is_real'] = '是否實體商品';
