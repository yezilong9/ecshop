...
$_LANG['license_notice'] = '證書是您享受服務的唯一標識，它記錄了您的網店的授權信息、購買官方服務記錄、短信賬戶等重要信息。您需要通過“證書下載備份”功能備份證書，并妥善保管。在您遇到商店系統需要重新安裝時，可以在新安裝的系統中使用“證書上傳恢復”功能將之前的證書恢復，這樣新系統就可以繼續使用證書內的重要信息。';
