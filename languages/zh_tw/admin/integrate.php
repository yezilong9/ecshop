...
$_LANG['need_not_setup'] = '當您採用會員系統時，無須進行設置。';
...
$_LANG['ucenter_notice_key'] = '通信密鑰用於在 UCenter 和  之間傳輸信息的加密，可包含任何字母及數字，請在 UCenter 與  設置完全相同的通訊密鑰，以確保兩套系統能夠正常通信';
...
$_LANG['uc_notice_ip'] = '連接的過程中出了點問題，請您填寫服務器 IP 地址，如果您的 UC 與  裝在同一服務器上，我們建議您嘗試填寫 127.0.0.1';
