...
$_LANG['information_category'] = '资讯分类名称管理';
$_LANG['information'] = '资讯信息发布管理';
...
$_LANG['shop_code'] = '验证码管理';
$_LANG['shop_email'] = '邮件服务器设置';
...
//ccx 增加了对库存管理的权限的分配 goods_stock 
$_LANG['stock_manage']               = '商品库存管理';
$_LANG['stock_control']              = '库存采购管理';
$_LANG['stock_log_list']             = '库存管理日志';
$_LANG['stock_control_list']         = '商品库存列表';
$_LANG['stock_control_ruku']         = '商品入库记录';
$_LANG['goods_stock_list']           = '采购商品列表';
$_LANG['goods_stock_info']           = '采购清单列表';

$_LANG['stock_out_type']             = '出库类型管理';
$_LANG['goods_stock_list_out']       = '出库商品列表';
$_LANG['goods_stock_info_out']       = '出库清单列表';
$_LANG['stock_ruku_handle']          = '采购操作(审核,入库)';
$_LANG['stock_zuofei_handle']        = '出库操作(审核,出库)';
