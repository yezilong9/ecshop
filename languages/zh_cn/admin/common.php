...
$_LANG['app_name'] = '';
$_LANG['cp_home'] = '管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2005-2015 广州新泛联数码有限公司，并保留所有权利。';
...
$_LANG['06_stats'] = '报表统计';
$_LANG['06_supply_goods'] = '供货管理';
$_LANG['06_app'] = 'APP信息管理';
...
$_LANG['supply'] = '供货管理';
$_LANG['app_manage'] = 'APP信息管理';

/* 商品管理 */
$_LANG['01_goods_list'] = '商品列表';
$_LANG['01_goods_special_list'] = '特产商品列表';

$_LANG['03_pay_payment'] = '支付模块';
...
$_LANG['11_order_del'] = '删除订单';

/* 广告管理 */
$_LANG['ad_position'] = '广告位置';
$_LANG['ad_list'] = '广告列表';
$_LANG['new_ad_list'] = '新广告列表';
$_LANG['new_position'] = '新广告位置';

/* 报表统计 */
$_LANG['tm_generalize'] = '天下代购推广统计';
...
$_LANG['04_information_category'] = '资讯分类';
$_LANG['05_information'] = '资讯列表';
...
/* APP信息管理 */
$_LANG['app_version'] = 'APP版本信息';
$_LANG['request_log'] = '请求记录';
...
$_LANG['11_agency_pay_log'] = '代理商营业额记录';
$_LANG['agency_pay_log'] = '扣代理商金额记录';
...
$_LANG['03_goods_stock'] = '商品库存管理';
$_LANG['goods_supplier_list'] = '供货商商品列表';
$_LANG['goods_stock_control'] = '库存采购管理';
$_LANG['goods_stock_log'] = '库存管理日志';
$_LANG['edit_goods_stock'] = '设置相关库存信息';
$_LANG['goods_stock_control_list'] = '商品库存列表';
$_LANG['goods_stock_control_ruku'] = '商品入库记录';

$_LANG['01_goods_stock_control'] = '库存采购管理';
$_LANG['02_goods_stock_log'] = '库存管理日志';
$_LANG['04_goods_stock_control_list'] = '商品库存列表';
$_LANG['05_goods_stock_control_ruku'] = '商品入库记录';

$_LANG['06_goods_stock_control'] = '库存采购管理_new';
$_LANG['07_goods_stock_list'] = '采购商品列表';
$_LANG['08_goods_stock_info_list'] = '采购清单列表';

$_LANG['stock_manage']               = '商品库存管理';
$_LANG['01stock_control']              = '库存采购管理';
$_LANG['02stock_log_list']             = '库存管理日志';
$_LANG['03stock_control_list']         = '商品库存列表';
$_LANG['04stock_control_ruku']         = '商品入库记录';
$_LANG['06goods_stock_list']           = '采购商品列表';
$_LANG['07goods_stock_info']           = '采购清单列表';

$_LANG['08stock_out_type']             = '出库类型管理';
$_LANG['09stock_goods_out']            = '出库商品列表';
$_LANG['10stock_info_out']             = '出库清单列表';

/*
**2015-03-13 ccx 后台新增分润栏目管理
*/
$_LANG['17_splitting']             = '分润管理';
$_LANG['split_share']              = '分润提成';
$_LANG['split_instal']             = '分润设置';

$_LANG['compensate_instal']        = '补偿比例设置';
$_LANG['consumer_compensate']      = '消费补偿';
?>