...
$_LANG['add_goods_ok'] = '完成了对供货商的商品操作管理。';
...
/*ccx  2014-11-14 新增语言包*/
$_LANG['is_purchase'] = '已采购';
$_LANG['not_is_purchase'] = '未采购';
$_LANG['make_purchase'] = '确定采购';
$_LANG['remove_purchase'] = '取消采购';
$_LANG['supplier_goods_cat'] = '商品分类';
$_LANG['is_make_purchase'] = '您确定要对该商品进行采购？';
$_LANG['no_make_purchase'] = '您确定要对该商品取消采购？';
$_LANG['purchase_success_message'] = '对该供货商商品的采购操作成功。';
$_LANG['purchase_fail_message'] = '对该供货商商品的取消采购操作成功。';
?>