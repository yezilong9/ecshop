...
$_LANG['cfg_name']['is_start_sms'] = '是否启用手机短信服务';
//$_LANG['cfg_name']['sms_shop_mobile'] = '商家的手机号码';
$_LANG['cfg_name']['sms_order_placed'] = "客户下订单时是否给<span style='color:red'>商家</span>发短信";
$_LANG['cfg_name']['sms_order_payed'] = "客户付款时是否给<span style='color:red'>商家</span>发短信";
$_LANG['cfg_name']['sms_order_shipped'] = "商家发货时是否给<span style='color:red'>客户</span>发短信";
...
$_LANG['cfg_range']['is_start_sms']['1'] = '启用';
$_LANG['cfg_range']['is_start_sms']['0'] = '不启用';
