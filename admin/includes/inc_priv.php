...
//商品管理权限
    ...
    $purview['11_goods_trash']       = 'remove_back';
    ...
    $purview['52_virtual_card_change'] = 'virualcard_key';
...
//文章管理权限
    ...
    $purview['04_information_category']  = 'information_category';
    $purview['05_information']  	 = 'information';
...
//会员管理权限
    ...
    $purview['11_agency_pay_log'] = 'agency_pay_log';
...
//商店设置权限
    ...
    $purview['03_pay_payment']       = 'pay';
    $purview['01_url_config']       = 'agency_url_config';
...
//广告管理
    ...
    $purview['new_ad_list']              = 'ad_manage';
    $purview['new_position']         = 'ad_manage';
...
//订单管理权限
    ...
    $purview['11_order_del']         = 'order_del';

//报表统计权限
    $purview['flow_stats']           = 'client_flow_stats';
    $purview['tm_generalize']        = 'client_flow_stats';
...
//供货管理
	$purview['app_version']           = 'app_version';
	$purview['request_log']           	= 'request_log';	
...
//邮件群发管理
    ...
    //ccx 商品库存管理  
    $purview['stock_manage']         = 'stock_manage';
    $purview['01stock_control']        = 'stock_control';	
    $purview['02stock_log_list']       = 'stock_log_list';	
    $purview['03stock_control_list']   = 'stock_control_list';	
    $purview['04stock_control_ruku']   = 'stock_control_ruku';	
    $purview['06goods_stock_list']     = 'goods_stock_list';	
    $purview['07goods_stock_info']     = 'goods_stock_info';	
    
    $purview['08stock_out_type']       = 'stock_out_type';
    $purview['09stock_goods_out']      = 'goods_stock_list_out';
    $purview['10stock_info_out']       = 'goods_stock_info_out';
    
    //ccx 供货商商品列表权限分配管理
    $purview['goods_supplier_list']     = 'goods_supplier_list';
?>