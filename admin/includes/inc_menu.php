...
$modules['02_cat_and_goods']['01_goods_special_list']  = 'goods.php?act=special_list';// 特产商品列表
...
//ccx 供货商商品列表，商品采购列表， 采购流程列表
$modules['02_cat_and_goods']['goods_supplier_list']              = 'goods_supplier.php?act=list';
//$modules['03_goods_stock']['01_goods_stock_control']             = 'goods_stock_control.php?act=list';
$modules['03_goods_stock']['02stock_log_list']                 = 'stock_control_log.php?act=list';
$modules['03_goods_stock']['03stock_control_list']        = 'stock_control.php?act=stock_control_list';
$modules['03_goods_stock']['04stock_control_ruku']        = 'stock_control_ruku.php?act=list';
$modules['03_goods_stock']['01stock_control']             = 'goods_stock_control_new.php?act=list';
$modules['03_goods_stock']['06goods_stock_list']                = 'goods_stock_list.php?act=list';
$modules['03_goods_stock']['07goods_stock_info']           = 'goods_stock_info.php?act=list';

$modules['03_goods_stock']['08stock_out_type']            = 'stock_out_type.php?act=list';
$modules['03_goods_stock']['09stock_goods_out']           = 'goods_stock_list_out.php?act=list';
$modules['03_goods_stock']['10stock_info_out']            = 'goods_stock_info_out.php?act=list';
...
$modules['05_banner']['new_ad_list']                = 'new_ads.php?act=list';
$modules['05_banner']['new_position']               = 'new_position.php?act=list';

$modules['06_app']['app_version'] 						= 'app_version.php?act=list';
$modules['06_app']['request_log'] 						= 'request_log.php?act=list';

$modules['06_supply_goods']['souwu'] 				= 'souwu.php?act=list';
$modules['06_supply_goods']['tm'] 				    = 'tm_goods.php?act=list';
$modules['06_stats']['flow_stats']                  = 'flow_stats.php?act=view';
$modules['06_stats']['tm_generalize']               = 'skip.php?act=tm';
...
//$modules['06_stats']['financial']               	= 'financial_list.php?act=list';
...
$modules['07_content']['04_information_category']   = 'information_category.php?act=list';
$modules['07_content']['05_information']       = 'information.php?act=list';
...
$modules['08_members']['11_agency_pay_log']         = 'agency_pay_log.php?act=list';
...
$modules['11_system']['01_url_config']             = 'agency_url_config.php?act=list';//代理商域名设置
//$modules['11_system']['shop_authorized']             = 'license.php?act=list_edit';
$modules['11_system']['02_payment_list']            = 'payment.php?act=list';
$modules['11_system']['03_pay_payment']        		= 'pay.php?act=payment';          // 支付管理
$modules['11_system']['03_shipping_list']           = 'shipping.php?act=list';
//$modules['11_system']['shipping_area_list']         = 'shipping_area.php?act=list';
//$modules['11_system']['freight']         = 'freight.php?act=list';
...
//ccx 2015-03-13 分润管理 消费补偿设置
$modules['17_splitting']['split_instal']            = 'split_instal.php?act=list';
$modules['17_splitting']['split_share']             = 'split_share.php?act=list';

$modules['17_splitting']['compensate_instal']       = 'compensate_instal.php?act=list';
$modules['17_splitting']['consumer_compensate']     = 'consumer_compensate.php?act=list';
?>
