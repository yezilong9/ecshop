...
if ($_REQUEST['act'] == 'list' || $_REQUEST['act'] == 'trash')
{
    ...
    $smarty->assign('cat_list',   cat_list_ccx(0, 0, true));
...
{	//echo $_REQUEST['act'];
    ...
    if ($is_add)
    {
		...
		if($agency_user_id){ //如果是代理商，商品的默认库存数量为0，主站默认为0
			if ($code != '')
			{
				$goods['goods_number'] = 0;
			}else{
				$goods['goods_number'] = 0;//商品的默认库存数量为1
			}
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update' || $_REQUEST['act'] == 'special_update')
{
	...
	/*add by ccx for date 2015-03-26 获取商品的分润比例 */
	$split_percent = !empty($_POST['split_percent']) ? $_POST['split_percent'] : 0;
	/*end*/
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id,admin_agency_id,wholesale_price,costing_price,start_num, goods_shipai,province_id,province_name,city_id,city_name,area_id,area_name, split_percent )" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    ...
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id','$admin_agency_id','$wholesale_price','$costing_price','$start_num', '$_POST[goods_shipai]',$province_id,'$province_name',$city_id,'$city_name',$area_id,'$area_name', $split_percent )";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral,admin_agency_id,  goods_shipai, split_percent )" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral', '$admin_agency_id', '$_POST[goods_shipai]', '$split_percent' )";
        }
